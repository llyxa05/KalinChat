...
public class Start {
     ...
     * ИДЕИ АНД БАГЕС
     * 
     * звук при приходе сообщения, уведомление в винде 50/50
     * настройки клиента
     * удаляшки текста из поля, когда оно отправлено FIXED
     * отправляшки когда нажал энтер
     * автоскролл вниз
     * перенести пиво5крипт
     * сделать кнопку "гагага" по просьбе Санька
     * если сообщение пустое, то не отправлять его FIXED
     * сделать шрифт жирнее(там где отправить сообщение и поле для ввода)
     * */
}
